...
/**
 * Servlet implementation class sit1
 */
@WebServlet("/sit1")
public class sit1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	           ...
	           rs=stmt.executeQuery("select  *  from  location1 where name='The rack' and time='2021-12-25-10:00'");
