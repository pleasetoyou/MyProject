...
public class Booking2 extends HttpServlet {
	...
	protected synchronized void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("電影名稱:TOP GUN");		
		...
		try {			   
	           ...
	           stmt.executeUpdate("insert into location2(seat,ID,name,time,price)values('"+seat+"','"+ID+"','TOP GUN','2021-12-25-12:00','"+price+"')");
			   ...
			   fw.append("\n\n");
			   fw.append("身分證:"+ID+"\n");
			   fw.append("電影名稱:TOP GUN"+"\n");
			   fw.append("座位:"+seat+"\n");
			   fw.append("電影時刻:2021-12-25-12:00"+"\n");
			   fw.append("票價:"+price+"\n");
	    ...
	    out.println("<a href='Input2.html'>購票</a> <br/>");
	    out.println("<a href='Ticket2.html'>退票系統</a> <br/>");
	    out.print("</body></html>");
     out.close();	   	           
		}catch(Exception e)
	    {
